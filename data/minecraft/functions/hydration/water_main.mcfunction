...
scoreboard players add @a[scores={unFilteredWater=1..}] Hydration 8
...
scoreboard players add @a[scores={CleanWater=1..}] Hydration 10

effect give @a[scores={Hydration=..40}] minecraft:weakness 200
effect give @a[scores={Hydration=..20}] minecraft:slowness 200
